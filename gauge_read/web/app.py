...
async def realtime_frame(
    ...
    with _infer_lock:
        ...
        runtime_logic = NativeGaugeApp(get_cfg())
        ...
        try:
            ...
            return {
                ...
                "reason": str(exc),
                "ocr_error": False,
                "start_value": format_metric(start_value),
                "end_value": format_metric(end_value),
            }
        ...
        if manual_values:
            ...
            reading = runtime_logic.recalculate()
        ...
        if ocr_failed:
            return {
                ...
                "reason": "OCR失败",
                "ocr_error": True,
                "start_value": format_metric(detected_start),
                "end_value": format_metric(detected_end),
            }

        return {
            "valid": True,
            "reading_label": "读数结果",
            "reading": format_metric(runtime_logic.current_value),
            "ratio": format_metric(runtime_logic.current_ratio),
            "ocr_error": False,
            "start_value": format_metric(runtime_logic.current_start_value if manual_values else detected_start),
            "end_value": format_metric(runtime_logic.current_end_value if manual_values else detected_end),
        }
